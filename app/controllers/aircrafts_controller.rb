class AircraftsController < ApplicationController
  ...
  before_action :get_make_model_ids, only: [:show, :edit, :update, :new]
  ...
  private
    ...
    def aircraft_params
      params.require(:aircraft).permit(:n_number, :serial_number, :ac_make_model_id, :notes)
    end

    def get_make_model_ids
      @ac_make_models_sorted = AcMakeModel.all.order(:abbreviation).map{|m|[m.abbreviation, m.id]}
    end
end

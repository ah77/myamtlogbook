class EnginesController < ApplicationController
  ...
  before_action :get_aircraft_ids
  ...
  private
    ...
    def engine_params
      params.require(:engine).permit(:name, :serial_number, :manufacturer, :model, :notes, :aircraft_id)
    end

    def get_aircraft_ids
      @aircrafts_sorted = Aircraft.all.order(:n_number).map{|m|[m.n_number, m.id]}
    end

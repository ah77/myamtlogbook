...
class EnginesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engine" do
    assert_difference('Engine.count') do
      post engines_url, params: { engine: { aircraft_id: @engine.aircraft_id, manufacturer: @engine.manufacturer, model: @engine.model, name: @engine.name, notes: @engine.notes, serial_number: @engine.serial_number } }
    end
  ...
  test "should update engine" do
    patch engine_url(@engine), params: { engine: { aircraft_id: @engine.aircraft_id, manufacturer: @engine.manufacturer, model: @engine.model, name: @engine.name, notes: @engine.notes, serial_number: @engine.serial_number } }
